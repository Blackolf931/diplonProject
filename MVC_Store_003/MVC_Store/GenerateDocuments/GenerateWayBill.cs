...
namespace MVC_Store.GenerateDocuments
{
    public class GenerateWayBill
    {
        public class GeneratedClass
        {
            // Creates a WordprocessingDocument.
            public void CreatePackage(WayBillVM model, List<ProductVM> products)
            {
                using (WordprocessingDocument package = WordprocessingDocument.Create($@"D:\Diplom\diplonProject\MVC_Store_003\Отчеты\Накладная №{model.DocumentNumber}.docx", WordprocessingDocumentType.Document))
                {
                    CreateParts(package, model, products);
                }
            }

            // Adds child parts and generates content of the specified part.
            private void CreateParts(WordprocessingDocument document, WayBillVM model, List<ProductVM> products)
            {
                ExtendedFilePropertiesPart extendedFilePropertiesPart1 = document.AddNewPart<ExtendedFilePropertiesPart>("rId3");
                GenerateExtendedFilePropertiesPart1Content(extendedFilePropertiesPart1);

                MainDocumentPart mainDocumentPart1 = document.AddMainDocumentPart();
                GenerateMainDocumentPart1Content(mainDocumentPart1, model, products);
            ...
            private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1, WayBillVM model, List<ProductVM> products)
            {
                ...
                Text text3 = new Text();
                text3.Text = $"{model.DocumentNumber}";
                ...
                text5.Text = $"Получатель: {model.ProviderName}";
                ...
                text7.Text = $"Отправитель:{model.RecipientName}";
                ...
                {
                    text11.Text = $"Название продукта: {products[i].Name} Цена за еденицу: {products[i].Price} Количетсво: 1  Общая сумма: {products[i].Price * 1}\t \t \t";
                }
                ...
                text12.Text = $"\t \t \t \t Продукцию принял: {model.TheCargoWasRealesed} Подпись";
                ...
                text14.Text = $"Дата ({model.CreatedAt})";
