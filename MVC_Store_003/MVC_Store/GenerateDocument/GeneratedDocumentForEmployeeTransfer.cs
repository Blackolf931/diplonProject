...
namespace GeneratedCode
{
    public class GeneratedDocument
    {
        ...
        public void CreatePackage(string filePath, string EmployeeName, string SurName, string Patronomic, string department, string nameInspector, string surNameInspector, string patronomicInspector)
        {
            using (WordprocessingDocument package = WordprocessingDocument.Create(filePath, WordprocessingDocumentType.Document))
            {
                CreateParts(package, EmployeeName, SurName, Patronomic, department, nameInspector, surNameInspector, patronomicInspector);
            }
        }

        // Adds child parts and generates content of the specified part.
        private void CreateParts(WordprocessingDocument document, string EmployeeName, string SurName, string Patronomic, string department, string nameInspector, string surNameInspector, string patronomicInspector)
        {
            ExtendedFilePropertiesPart extendedFilePropertiesPart1 = document.AddNewPart<ExtendedFilePropertiesPart>("rId3");
            GenerateExtendedFilePropertiesPart1Content(extendedFilePropertiesPart1);

            MainDocumentPart mainDocumentPart1 = document.AddMainDocumentPart();
            GenerateMainDocumentPart1Content(mainDocumentPart1, EmployeeName, SurName, Patronomic, department, nameInspector, surNameInspector, patronomicInspector);
        ...
        private void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1)
        {
            ...
            charactersWithSpaces1.Text = "171";
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1, string EmployeeName, string SurName, string Patronomic, string department, string nameInspector, string surNameInspector, string patronomicInspector)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphMarkRevision = "003C0341", RsidParagraphAddition = "002E4855", RsidParagraphProperties = "00D85452", RsidRunAdditionDefault = "00D85452" };
            ...
            Run run2 = new Run() { RsidRunProperties = "003C0341" };
            ...
            Run run4 = new Run() { RsidRunProperties = "003C0341" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "00D85452", RsidParagraphProperties = "00D85452", RsidRunAdditionDefault = "00D85452" };
            ...
            text5.Text = "Отчет для ";

            run5.Append(runProperties5);
            run5.Append(text5);

            Run run6 = new Run() { RsidRunAddition = "003C0341" };
            ...
            text6.Text = $"перевода в другой отдел №{rand.Next(0,1000)}";
            ...
            Paragraph paragraph3 = new Paragraph() { RsidParagraphAddition = "003C0341", RsidParagraphProperties = "003C0341", RsidRunAdditionDefault = "002F4EB5" };
            ...
            Text text7 = new Text();
            text7.Text = $"Сотрудник {SurName} {EmployeeName} {Patronomic} переведен в отдел {department}";
            ...
            Paragraph paragraph4 = new Paragraph() { RsidParagraphAddition = "003C0341", RsidParagraphProperties = "003C0341", RsidRunAdditionDefault = "003C0341" };
            ...
            text10.Text = $"{dateTime.Month} {dateTime.Year}г.";
            ...
            Paragraph paragraph5 = new Paragraph() { RsidParagraphAddition = "003C0341", RsidParagraphProperties = "003C0341", RsidRunAdditionDefault = "003C0341" };
            ...
            Paragraph paragraph6 = new Paragraph() { RsidParagraphMarkRevision = "003C0341", RsidParagraphAddition = "003C0341", RsidParagraphProperties = "003C0341", RsidRunAdditionDefault = "003C0341" };
            ...
            text11.Text = $"Сотрудник отдела кадров {surNameInspector} {nameInspector} {patronomicInspector} ФИО Подпись____";
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "003C0341", RsidR = "003C0341" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00D6506C" };
            Rsid rsid1 = new Rsid() { Val = "002E4855" };
            Rsid rsid2 = new Rsid() { Val = "002F4EB5" };
            Rsid rsid3 = new Rsid() { Val = "003C0341" };
            Rsid rsid4 = new Rsid() { Val = "00D6506C" };
            Rsid rsid5 = new Rsid() { Val = "00D85452" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "29D85801" };
            ...
            OpenXmlUnknownElement openXmlUnknownElement2 = OpenXmlUnknownElement.CreateOpenXmlUnknownElement("<w15:docId w15:val=\"{760B1DC6-FDE5-49DD-9EFC-8C6D520CCA63}\" xmlns:w15=\"http://schemas.microsoft.com/office/word/2012/wordml\" />");
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            RunFonts runFonts18 = new RunFonts() { AsciiTheme = ThemeFontValues.MinorHighAnsi, HighAnsiTheme = ThemeFontValues.MinorHighAnsi, EastAsiaTheme = ThemeFontValues.MinorHighAnsi, ComplexScriptTheme = ThemeFontValues.MinorBidi };
            ...
            runPropertiesBaseStyle1.Append(runFonts18);
            runPropertiesBaseStyle1.Append(fontSize18);
            runPropertiesBaseStyle1.Append(fontSizeComplexScript18);
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2020-05-25T09:42:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2020-05-25T10:24:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
