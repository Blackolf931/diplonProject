...
namespace GenerateDocument
{
    public class GeneratedClass
    {
        ...
        public void CreatePackage(string filePath, string EmployeeName, string SurName, string Patronomic, string department, string nameInspector, string surNameInspector, string patronomicInspector, DateTime dateTime)
        {
            using (WordprocessingDocument package = WordprocessingDocument.Create(filePath, WordprocessingDocumentType.Document))
            {
                CreateParts(package, EmployeeName, SurName, Patronomic, department, nameInspector, surNameInspector, patronomicInspector, dateTime);
            }
        }

        // Adds child parts and generates content of the specified part.
        private void CreateParts(WordprocessingDocument document, string EmployeeName, string SurName, string Patronomic, string department, string nameInspector, string surNameInspector, string patronomicInspector, DateTime dateTime)
        {
            ExtendedFilePropertiesPart extendedFilePropertiesPart1 = document.AddNewPart<ExtendedFilePropertiesPart>("rId3");
            GenerateExtendedFilePropertiesPart1Content(extendedFilePropertiesPart1);

            MainDocumentPart mainDocumentPart1 = document.AddMainDocumentPart();
            GenerateMainDocumentPart1Content(mainDocumentPart1, EmployeeName,  SurName,  Patronomic,  department,  nameInspector, surNameInspector, patronomicInspector, dateTime);
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1, string EmployeeName, string SurName, string Patronomic, string department, string nameInspector, string surNameInspector, string patronomicInspector, DateTime dateTime)
        {
            ...
            Run run9 = new Run() { RsidRunAddition = "009423EC" };
            ...
            Text text9 = new Text();
            text9.Text = $"стаж работы в данной организации составляет {((int)(DateTime.Now - dateTime).TotalDays).ToString()} дней";
            ...
            paragraphMarkRunProperties4.Append(fontSize13);
            paragraphMarkRunProperties4.Append(fontSizeComplexScript13);
            ...
            text10.Text = $"{surNameInspector} {nameInspector} {patronomicInspector}";
            ...
            text14.Text = $"{DateTime.Today.Day})";
            ...
            text15.Text = $"{DateTime.Today.Month} {DateTime.Today.Year}г.";
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            Rsid rsid4 = new Rsid() { Val = "00F61AE4" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            runPropertiesBaseStyle1.Append(runFonts22);
            runPropertiesBaseStyle1.Append(fontSize22);
            runPropertiesBaseStyle1.Append(fontSizeComplexScript22);
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2020-05-26T13:31:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2020-05-26T13:31:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
