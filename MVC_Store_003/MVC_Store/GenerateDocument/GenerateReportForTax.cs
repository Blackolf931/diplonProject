...
namespace GeneratedCodeForTaxReport
{
    public class GeneratedClass
    {
        // Creates a WordprocessingDocument.
        public void CreatePackage(string filePath, string EmployeeName, string SurName, string Patronomic, DateTime date, string address, string nameInspector, string surNameInspector, string patronomicInspector)
        {
            using (WordprocessingDocument package = WordprocessingDocument.Create(filePath, WordprocessingDocumentType.Document))
            {
                CreateParts(package, EmployeeName, SurName, Patronomic, date,  address, nameInspector, surNameInspector, patronomicInspector);
            }
        }

        // Adds child parts and generates content of the specified part.
        private void CreateParts(WordprocessingDocument document, string EmployeeName, string SurName, string Patronomic, DateTime date, string address, string nameInspector, string surNameInspector, string patronomicInspector)
        {
            ExtendedFilePropertiesPart extendedFilePropertiesPart1 = document.AddNewPart<ExtendedFilePropertiesPart>("rId3");
            GenerateExtendedFilePropertiesPart1Content(extendedFilePropertiesPart1);

            MainDocumentPart mainDocumentPart1 = document.AddMainDocumentPart();
            GenerateMainDocumentPart1Content(mainDocumentPart1, EmployeeName, SurName, Patronomic, date, address, nameInspector, surNameInspector, patronomicInspector);
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1, string EmployeeName, string SurName, string Patronomic, DateTime date, string address, string nameInspector, string surNameInspector, string patronomicInspector)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphMarkRevision = "009423EC", RsidParagraphAddition = "002E4855", RsidParagraphProperties = "001946A9", RsidRunAdditionDefault = "001946A9" };
            ...
            Run run2 = new Run() { RsidRunProperties = "009423EC" };
            ...
            Text text3 = new Text();
            text3.Text = "Рога и Лопата";

            run3.Append(runProperties3);
            run3.Append(text3);

            Run run4 = new Run() { RsidRunProperties = "009423EC" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "001946A9", RsidParagraphProperties = "001946A9", RsidRunAdditionDefault = "001946A9" };
            ...
            Run run6 = new Run() { RsidRunAddition = "009423EC" };
            ...
            Paragraph paragraph3 = new Paragraph() { RsidParagraphAddition = "001946A9", RsidParagraphProperties = "001946A9", RsidRunAdditionDefault = "001946A9" };
            ...
            text8.Text = $"Для сотрудника {SurName}  {EmployeeName}  {Patronomic}";

            run8.Append(runProperties8);
            run8.Append(text8);

            Run run9 = new Run() { RsidRunAddition = "00CC32FD" };
            ...
            text9.Text = $"проживающего по адресу {address} ";

            run9.Append(runProperties9);
            run9.Append(text9);

            Run run10 = new Run() { RsidRunAddition = "009423EC" };
            ...
            text10.Text = $"стаж работы в данной организации составляет {(int)(DateTime.Now -date).TotalDays} дней";
            ...
            Paragraph paragraph4 = new Paragraph() { RsidParagraphAddition = "001946A9", RsidParagraphProperties = "001946A9", RsidRunAdditionDefault = "001946A9" };
            ...
            Paragraph paragraph5 = new Paragraph() { RsidParagraphAddition = "001946A9", RsidParagraphProperties = "001946A9", RsidRunAdditionDefault = "001946A9" };
            ...
            text12.Text = $"{surNameInspector}  {nameInspector}  {patronomicInspector} Подпись";
            ...
            Paragraph paragraph6 = new Paragraph() { RsidParagraphMarkRevision = "001946A9", RsidParagraphAddition = "001946A9", RsidParagraphProperties = "001946A9", RsidRunAdditionDefault = "001946A9" };
            ...
            text14.Text = $"Дата ({DateTime.Now.Day})";

            run14.Append(runProperties14);
            run14.Append(text14);

            Run run15 = new Run() { RsidRunAddition = "00CC32FD" };
            ...
            text16.Text = $"{DateTime.Now.Month} {DateTime.Now.Year} г.";
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "001946A9", RsidR = "001946A9" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00F61AE4" };
            Rsid rsid1 = new Rsid() { Val = "001946A9" };
            Rsid rsid2 = new Rsid() { Val = "002E4855" };
            Rsid rsid3 = new Rsid() { Val = "009423EC" };
            Rsid rsid4 = new Rsid() { Val = "00CC32FD" };
            Rsid rsid5 = new Rsid() { Val = "00F61AE4" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "4202C1B2" };
            ...
            OpenXmlUnknownElement openXmlUnknownElement2 = OpenXmlUnknownElement.CreateOpenXmlUnknownElement("<w15:docId w15:val=\"{CCDBBA0F-631F-441D-8705-916EF9B6EC2E}\" xmlns:w15=\"http://schemas.microsoft.com/office/word/2012/wordml\" />");
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            RunFonts runFonts23 = new RunFonts() { AsciiTheme = ThemeFontValues.MinorHighAnsi, HighAnsiTheme = ThemeFontValues.MinorHighAnsi, EastAsiaTheme = ThemeFontValues.MinorHighAnsi, ComplexScriptTheme = ThemeFontValues.MinorBidi };
            ...
            runPropertiesBaseStyle1.Append(runFonts23);
            runPropertiesBaseStyle1.Append(fontSize23);
            runPropertiesBaseStyle1.Append(fontSizeComplexScript23);
        ...
        {
            document.PackageProperties.Creator = "Deb novikov";
            document.PackageProperties.Title = "";
            document.PackageProperties.Subject = "";
            document.PackageProperties.Keywords = "";
            document.PackageProperties.Description = "";
            document.PackageProperties.Revision = "2";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2020-05-26T13:32:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2020-05-26T13:32:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "Deb novikov";
        }
    }
}
