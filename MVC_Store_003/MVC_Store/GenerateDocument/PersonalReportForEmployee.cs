...
namespace GeneratedCodePersonalReport
{
    public class GeneratedClass
    {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1, string EmployeeName, string SurName, string Patronomic, DateTime date, string address, string nameInspector, string surNameInspector, string patronomicInspector)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "002E4855", RsidParagraphProperties = "001946A9", RsidRunAdditionDefault = "001946A9" };
            ...
            runProperties4.Append(languages3);
            Text text4 = new Text();
            text4.Text = "”";
            ...
            text5.Text = $"Отчет по личному делу №{rand.Next(1,1000)}";
            ...
            text6.Text = $"Для сотрудника {EmployeeName}  {SurName}  {Patronomic} {date} года рождения. Проживающего по адресу {address} ";
            ...
            Text text8 = new Text();
            text8.Text = $"{surNameInspector}  {nameInspector}  {patronomicInspector}  Подпись";
            ...
            text12.Text = $"{DateTime.Now.Month} {DateTime.Now.Year}г.";
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            Rsid rsid3 = new Rsid() { Val = "00F61AE4" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "0FA8C652" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            Languages languages4 = new Languages() { Val = "ru-RU", EastAsia = "en-US", Bidi = "ar-SA" };

            runPropertiesBaseStyle1.Append(runFonts19);
            runPropertiesBaseStyle1.Append(fontSize19);
            runPropertiesBaseStyle1.Append(fontSizeComplexScript19);
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2020-05-26T13:26:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2020-05-26T13:29:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
